...
class LoggerConfigurator extends \Everon\Logger\Configurator\AbstractLoggerConfigurator
{
    ...
    protected array $collectionItems = [
        'processorClassCollection' => '\\Everon\\Logger\\Configurator\\Plugin\\string',
    ];
    ...
    /**
     * @param string[]|null $processorClassCollection
     *
     * @return LoggerConfigurator
     */
     ...
     * @return LoggerConfigurator
     */
    public function addProcessorClass(string $item): LoggerConfigurator
    {
