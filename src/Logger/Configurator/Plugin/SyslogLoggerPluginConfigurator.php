 ...
 */
class SyslogLoggerPluginConfigurator extends \Everon\Logger\Configurator\AbstractPluginConfigurator 
{
  ...
  'logopts' => 'int',
     ...
     */
    public function setPluginClass(?string $pluginClass): SyslogLoggerPluginConfigurator
    {
     ...
     * @return SyslogLoggerPluginConfigurator
     */
    public function setPluginFactoryClass(?string $pluginFactoryClass): SyslogLoggerPluginConfigurator
    {
