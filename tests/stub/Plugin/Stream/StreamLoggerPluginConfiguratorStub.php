...
class StreamLoggerPluginConfiguratorStub implements PluginConfiguratorInterface
{
    ...
    public const STREAM_LOCATION = 'streamLocation';
    public const FILE_PERMISSION = 'filePermission';
    public const USE_LOCKING = 'useLocking';
    ...
    protected const METADATA = [
        ...
        'streamLocation' => [
            ...
            'default' => null,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'streamLocation',
        ],
        'filePermission' => [
            'type' => 'int',
            'default' => 644,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'filePermission',
        ],
        'useLocking' => ['type' => 'bool', 'default' => false, 'mappingPolicy' => [], 'mappingPolicyValue' => 'useLocking'],
    ];
    ...
    protected ?int $filePermission = 644;
    ...
    public function requireStreamLocation(): string
    {
        ...
        $this->setupDateTimeProperty('streamLocation');
    ...
    public function setStreamLocation(?string $streamLocation): self
    {
        ...
        $this->updateMap['streamLocation'] = true;
        return $this;
    }
    ...
    public function requireFilePermission(): int
    {
        ...
        $this->setupDateTimeProperty('filePermission');
    ...
    public function setFilePermission(?int $filePermission): self
    {
        ...
        $this->updateMap['filePermission'] = true;
        return $this;
    }
    ...
    public function requireUseLocking(): bool
    {
        ...
        $this->setupDateTimeProperty('useLocking');
    ...
    public function setUseLocking(bool $useLocking): self
    {
        ...
        $this->updateMap['useLocking'] = true;
        return $this;
    }
}
